...
output_folder = resources_folder / "text_category_intern_vl_2"
...
for image_path in tqdm(images_folder.iterdir(), total=len(list(images_folder.iterdir())), desc="Category by InternVL2-8B"):
